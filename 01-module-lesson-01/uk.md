...
У змінній $year зберігається рік. Визначте, чи він високосний (у такому році є
29 лютого). Рік буде високосним у двох випадках: або він ділиться на 4, але при
цьому не ділиться на 100, або ділиться на 400.
